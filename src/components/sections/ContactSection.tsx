        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="px-6 py-3 bg-portfolio-blue-light text-white font-medium rounded-md hover:bg-portfolio-blue-dark transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
            >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="p-3 rounded-full bg-portfolio-blue-light/10 text-portfolio-blue-light hover:bg-portfolio-blue-light hover:text-white transition-colors"
                target="_blank"
